...
<div>
    <div id="ramka"></div>
    <p><button class="Find">Поиск</button></p>
    <div id="Страны">
    <input  list="country" placeholder="Куда вы хотите поехать?">
<datalist id="country">
          ...
          <option value="ДР Конго">Конго</option>
...
<input class="checkbox" id="check-1" type="checkbox">
  <label tabindex="1" for="check-1" class="checkbox-label">Я путешествую по работе</label>
  <br />
</div>
</template>
<script>
...
.Find:hover { background: #191970;
}
.Find:active { background: #0000FF;
}
#Страны{
position:absolute;
top:240px;
